...
public class ITVOverworldRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        {
            modifiedVanillaOverworldBuilder.replaceBiome(Biomes.FOREST, ITVBiomes.PURPUR_FOREST);
...
//                    .build().forEach(parameterPoint -> builder.add(parameterPoint, ITVBiomes.PURPUR_FOREST_KEY));
//
